...
public class EmployeeExceptionHandler {
    ...
    @ExceptionHandler
    public ResponseEntity<EmployeeErrorResponse>handleException(EmployeesNotFoundException exc){
        String error = String.valueOf(HttpStatus.NOT_FOUND.value());
        String message = exc.getMessage();
        return new ResponseEntity<>(new EmployeeErrorResponse(error,message,LocalDateTime.now()), HttpStatus.NOT_FOUND);
    }
